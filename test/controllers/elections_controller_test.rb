...
class ElectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create election" do
    assert_difference('Election.count') do
      post elections_url, params: { election: { description: @election.description, end_time: @election.end_time, name: @election.name, start_time: @election.start_time } }
    end
  ...
  test "should update election" do
    patch election_url(@election), params: { election: { description: @election.description, end_time: @election.end_time, name: @election.name, start_time: @election.start_time } }
